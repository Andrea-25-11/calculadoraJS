...
const modoOscuro = document.getElementsByName("darkMode")[0];
const ultimoDelete = document.getElementsByName("lastDelete")[0];
...
function del() { 
    var eliminarUltimo = operacion; 
    eliminarUltimo = eliminarUltimo.substring(0, opeActual.length -1); 
};
